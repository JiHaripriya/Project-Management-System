...
let utils = { popup, validateFields, validate, svgCircleMaker, resourceAPI, projectAPI, statusReportAPI, secretKey, arrayOfTechnologies, latestOfflineResourceList, chartMaker };
